...
export default function PageNotFound() {
  ...
  return (
    ...
    >
      ...
      <motion.div initial="hidden" animate="visible" variants={toLeftAnimation}>
        <Typography.Text className={`text-lg ${styles["message"]}`}>
          <span className="text-gray-800">
            Oops! The page you are looking for might have been moved or doesn't
            exist
          </span>
        </Typography.Text>
      </motion.div>

      <motion.div initial="hidden" animate="visible" variants={toTopAnimation}>
        <div className="xl:mt-2 lg:mt-1">
          <CustomButton theme="red" onClick={() => navigation(-1)} size="large">
            Go Back
          </CustomButton>
        </div>
      </motion.div>
